...
$suplit_id = preg_replace('/[^A-Za-z0-9.\-]/', '', ($_GET['supplier-code']));
        ...
        <div style="min-height:550px;"  class="col-lg-12  mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Supplier Transaction Log</h6>
...
<?php
$gt_sale =mysqli_query($con,"SELECT * FROM expenses WHERE customer='$suplit_id' ORDER BY id DESC");
