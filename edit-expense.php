...
$org_id=preg_replace('/[^A-Za-z0-9.\-]/', '', ($_GET['edit-expense']));
$gt_grade = mysqli_query($con,"SELECT * FROM expenses WHERE id='$org_id'");
        ...
        <div   class="col-lg-12  mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Edit Expense</h6>
                         <?php
             if ($error) {
               // code...
              ?>
...
<option  <?php if ($ro['id']==($grade['customer'])) {
    echo "selected";
  }?>  value="<?php echo(htmlentities($ro['id']));?>"><?php echo(htmlentities($ro['suppliername']));?></option>
  <?php
}
?>
  </select>
...
<?php } ?>
  ...
  <br>
  <button name="update_expense" class="btn bg-gradient-danger" style="width:68%;"> Update Expense </button>
</form>
