...
if (isset($_GET['suspend-customer'])) {
	// code...
...
$user_id = preg_replace('/[^A-Za-z0-9.\-]/', '', ($_GET['suspend-customer']));
...
$update_user = mysqli_query($con,"UPDATE customers SET customer_status='suspended' WHERE id='$user_id'");
if ($update_user) {
	// code...
