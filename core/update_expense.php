...
$save_supplier = mysqli_query($con,"UPDATE expenses SET customer='$customer',receiptnumber='$receiptnumber',productname='$productname',handler='$handler',otherinfo='$otherinfo',quantity='$quantity',unitprice='$unitprice',status='$status',amount='$amount' WHERE receiptnumber='$receiptnumber'");

if($save_supplier)
{
	$message="Expense Update Complete.";
}
else
{
