        ...
        <div   class="col-lg-12  mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Manage Products <button data-toggle="modal" data-target="#newsupply" style="float:right;" class="btn bg-gradient-primary"> <i class="fa fa-plus-circle"></i> </button> </h6>
...
<?php
$gt_grades = mysqli_query($con,"SELECT * FROM products ORDER BY id  DESC");
...
{?>
     ...
     <a  class="btn btn-warning"  href="?suspend-product=<?php echo$row['id'];?>">
      <small>
...
else
{
  ?>
   ...
   <a class="btn btn-success" href="?activate-product=<?php echo$row['id'];?>"><small>
...
<form action="" method="post">
  <br>
  <input type="text" required class="form-control rounded-pill" placeholder="Product / Service Name" name="itemsupply">
  <br>
 <input type="text" required class="form-control rounded-pill" placeholder="Unit Of Measurement..." name="unitmeasurement">
   <br>
  <button name="add_product" class="btn bg-gradient-danger" style="width:68%;"> Add Product </button>
</form>
